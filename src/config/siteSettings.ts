...
const siteConfig: SiteConfig = {
  ...
  siteSettings: {
    ...
    seo: {
      ...
      defaultImage: '/image/group-1-1764502009520-7762fc.png',
    ...
    social: {
      ...
      linkedin: 'https://linkedin.com/company/beda.id',
      facebook: 'https://facebook.com/beda.id',
      instagram: 'https://instagram.com/beda.id',
      github: '',
      youtube: '',
    },
    contact: {
